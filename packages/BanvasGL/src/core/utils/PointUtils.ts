...
export class PointUtils {
     ...
     */
    public static isSamePoint(point1: Point3, point2: Point3, tolerance: number = 0.001): boolean {
     ...
     */
    public static isInRange(point: Point3, center: Point3, radius: number): boolean {
