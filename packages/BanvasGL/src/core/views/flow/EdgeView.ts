...
import { Action, Cursor, IEdgeView } from '@/core/interfaces'
import { Point3 } from '@/core/math'
import View, { InteractResult, ViewOptions } from '@/core/views/View/View'
import Bounds from '@/core/graph/base/Bounds'
import { isPortView } from '@/core/interfaces'
import type PortView from './PortView'
...
export default class EdgeView extends View implements IEdgeView {
    ...
    protected interactContent(_point: Point3): InteractResult {
        return { view: null, content: null, extraData: null }
    }
}
