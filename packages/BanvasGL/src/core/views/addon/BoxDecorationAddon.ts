...
import type Bounds from '@/core/graph/base/Bounds.js'
import { ADDONTYPE } from '@/core/constants/index.js'
import type { IBoxDecorationAddon } from '@/core/interfaces/index.js'
