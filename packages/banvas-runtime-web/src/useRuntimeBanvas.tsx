...
import { useCanvasInit } from './useCanvasInit.js'
import { useRuntimeEvents } from './useRuntimeEvents.js'
import type { UseCanvasOptions } from './useCanvasInit.js'

export type UseRuntimeBanvasOptions = UseCanvasOptions
...
/**
 * useRuntimeBanvas — 运行态 hook（Web 平台适配）
 *
 * 职责：
 *   - 加载序列化页面数据并渲染
 ...
 *
 * 使用场景：
 *   - 低代码平台内的"预览"模式（import from '@banyuan/banvas-runtime-web'）
