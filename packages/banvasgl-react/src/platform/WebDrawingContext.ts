...
function unwrapStyle(value: string | IGradient | IPattern): string | CanvasGradient | CanvasPattern {
 ...
 */
function unwrapImageSource(source: IImageSource): CanvasImageSource {
...
export class WebDrawingContext implements IDrawingContext {
  ...
  get fillStyle(): string | IGradient | IPattern {
    return this._ctx.fillStyle as unknown as string | IGradient | IPattern
  }
  set fillStyle(value: string | IGradient | IPattern) {
    this._ctx.fillStyle = unwrapStyle(value)
  }

  get strokeStyle(): string | IGradient | IPattern {
    return this._ctx.strokeStyle as unknown as string | IGradient | IPattern
  }
  set strokeStyle(value: string | IGradient | IPattern) {
  ...
  get lineCap(): LineCap {
    return this._ctx.lineCap as LineCap
  }
  ...
  get lineJoin(): LineJoin {
    return this._ctx.lineJoin as LineJoin
  }
  ...
  get imageSmoothingQuality(): ImageSmoothingQuality {
    return this._ctx.imageSmoothingQuality as ImageSmoothingQuality
  }
  ...
  get textAlign(): TextAlign {
    return this._ctx.textAlign as TextAlign
  }
  ...
  get textBaseline(): TextBaseline {
    return this._ctx.textBaseline as TextBaseline
  }
  ...
  getImageData(sx: number, sy: number, sw: number, sh: number): IImageSource {
    return this._ctx.getImageData(sx, sy, sw, sh) as unknown as IImageSource
  }
  putImageData(imagedata: IImageSource, dx: number, dy: number): void {
    this._ctx.putImageData(imagedata as unknown as ImageData, dx, dy)
  }
  createImageData(sw: number, sh: number): IImageSource {
    return this._ctx.createImageData(sw, sh) as unknown as IImageSource
  }
...
export function createWebDrawingContext(ctx: CanvasRenderingContext2D): IDrawingContext {
