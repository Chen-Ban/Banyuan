 ...
 */
export function useCanvasCore(options: UseCanvasCoreOptions): UseCanvasCoreResult {
  ...
  useEffect(() => {
    ...
    const _app = App.create(new WebSurface(canvasNode, options.rendererOptions), options.appOptions ?? {})
    _app.launch({})
    setApp(_app)
