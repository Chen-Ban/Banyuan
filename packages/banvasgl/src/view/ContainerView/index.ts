  ...
  implements IContainerView
{
   ...
   */
  protected override renderChildren(surface: IDrawingSurface, _offscreenCtx: IDrawingContext): void {
    this._children.forEach((view) => {
      if (!view.visible) return // renderToOffScreen 是 View 的 private 方法，通过 (view as any) 访问
