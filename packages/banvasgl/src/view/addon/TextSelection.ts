...
export default class TextSelection {
  ...
  constructor(fixedIndex: TextIndex | undefined, dynamicIndex: TextIndex | undefined) {
  ...
  public static isCursor(fixedIndex: TextIndex | undefined, dynamicIndex: TextIndex | undefined): boolean {
  ...
  public toDirectionlessIndex(): [TextIndex | undefined, TextIndex | undefined] {
    return TextSelection.toDirectionlessIndex(this.fixedIndex, this.dynamicIndex)
  }
