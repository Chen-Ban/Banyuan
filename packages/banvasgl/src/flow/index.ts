...
export type { MountContext, ContextFrame, StateProxy, CapProxy, FrontendCapProxy, BackendCapProxy } from './runtime/context.js'
export { contextGet } from './runtime/context.js'

// 执行器注册表
export { NodeExecutorRegistry } from './executors/registry.js'
export type { NodeExecutor, NodeExecResult } from './executors/registry.js'
...
export { setVariableExecutor, navigateExecutor, callFlowExecutor } from './executors/action-client.js'
