...
class FieldProxyService implements IFieldProxyService {
  async getFieldRegistry(): Promise<FieldGroup[]> {
    ...
    try {
      ...
      console.warn('[FieldProxyService] Failed to fetch fields from backend, using mock data.')
    }
