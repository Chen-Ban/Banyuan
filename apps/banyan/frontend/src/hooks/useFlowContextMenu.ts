...
function createNodeContextMenuItems(targetId: string, actions: IBanvasActions): FlowContextMenuItem[] {
  return [
    {
      key: 'delete-node',
      label: '删除节点',
...
function createEdgeContextMenuItems(targetId: string, actions: IBanvasActions): FlowContextMenuItem[] {
  return [
    {
      key: 'delete-edge',
      label: '删除连线',
...
function createCanvasContextMenuItems(actions: IBanvasActions): FlowContextMenuItem[] {
  return [
    {
      key: 'select-all',
      label: '全选',
...
export function useFlowContextMenu(actions: IBanvasActions | null): UseFlowContextMenuResult {
