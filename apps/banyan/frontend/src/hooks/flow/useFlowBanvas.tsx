...
import type { FlowContextMenuEvent } from './useFlowCanvasEvents'
import { extractSchema } from '../../components/FlowEditor/extractSchema'
import { NodeView, EdgeView, CLIENT_FLOW_NODE_MATERIALS, SERVER_FLOW_NODE_MATERIALS } from '@banyuan/banvasgl'
import type { FlowNodeMaterial } from '@banyuan/banvasgl'
import { createFlowMaterialPalette } from '../../components/FlowEditor/FlowMaterialPalette'
import type { FlowMaterialPaletteProps } from '../../components/FlowEditor/FlowMaterialPalette'
import type { FlowContextMenuState, FlowContextMenuItem } from '../../components/FlowEditor/FlowContextMenu'
...
export default function useFlowBanvas(
    ...
    const materials = useMemo(
        () => mode === 'server' ? SERVER_FLOW_NODE_MATERIALS : CLIENT_FLOW_NODE_MATERIALS,
        [mode],
    )
