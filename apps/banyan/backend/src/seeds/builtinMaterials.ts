    ...
    template: {
      root: {
        ...
        $value: {
          ...
          content: {
            $type: 'CIRCLE',
            $value: { id: '{{id:1}}', type: 'CIRCLE', center: { x: 50, y: 50, z: 0 }, radius: 50 },
          },
        },
      },
      idCount: 2,
        ...
        $value: {
          ...
          content: {
            ...
            $value: {
              ...
              controlPoints: [
                { x: 50, y: 0, z: 0 },
                { x: 100, y: 86.6025390625, z: 0 },
                { x: 0, y: 86.6025390625, z: 0 },
              ],
            },
          },
        },
        ...
        $value: {
          ...
          content: {
            ...
            $value: {
              ...
              controlPoints: [
                { x: 0, y: 0, z: 0 },
                { x: 39.599998474121094, y: -48, z: 0 },
                { x: 80.4000015258789, y: 48, z: 0 },
                { x: 120, y: 0, z: 0 },
              ],
            },
          },
      ...
      root: {
        ...
        $value: {
          schema: {
            ...
            category: 'compute',
            kind: 'math',
            slots: [{ input: { op: 'add', a: '', b: '' }, output: ['value'] }],
          },
        },
      },
      idCount: 1,
      ...
      root: {
        ...
        $value: {
          schema: {
            ...
            category: 'compute',
            kind: 'compare',
            slots: [{ input: { op: 'eq', a: '', b: '' }, output: ['value'] }],
          },
        },
      },
      idCount: 1,
      ...
      root: {
        ...
        $value: {
          schema: {
            ...
            category: 'compute',
            kind: 'logic',
            slots: [{ input: { op: 'and', a: '', b: '' }, output: ['value'] }],
          },
        },
      },
      idCount: 1,
      ...
      root: {
        ...
        $value: {
          schema: {
            ...
            category: 'compute',
            kind: 'format',
            slots: [{ input: { template: '', values: [] }, output: ['value'] }],
          },
        },
      },
      idCount: 1,
      ...
      root: {
        ...
        $value: {
          schema: {
            ...
            category: 'compute',
            kind: 'get',
            slots: [{ input: { object: '', path: '' }, output: ['value'] }],
          },
        },
      },
      idCount: 1,
      ...
      root: {
        ...
        $value: {
          schema: {
            ...
            kind: 'condition',
            slots: [
              { filter: { op: 'and', conditions: [{ left: '', op: 'eq', right: '' }] }, next: '' },
              { filter: { op: 'and', conditions: [] }, next: '' },
            ],
          },
        },
      },
      ...
      root: {
        ...
        $value: {
          schema: {
            ...
            slots: [
              {
                filter: { op: 'and', conditions: [{ left: '', op: 'eq', right: '' }] },
                body: { version: '2.0.0', entry: '', nodes: {} },
                next: '',
              },
            ],
          },
  ...
  },
  {
    ...
    template: {
      root: {
        $type: 'NODEVIEW',
        $value: {
          schema: { id: '{{id:0}}', category: 'control', kind: 'return', slots: [{ input: {}, output: [] }] },
        },
      },
      idCount: 1,
      internalIdRefs: [],
      ...
      root: {
        ...
        $value: {
          schema: {
            ...
            category: 'action',
            kind: 'setVariable',
            slots: [{ input: { target: '', value: '' }, output: [], next: '' }],
          },
        },
      },
      idCount: 1,
      ...
      root: {
        ...
        $value: {
          schema: {
            ...
            category: 'action',
            kind: 'setViewData',
            slots: [{ input: { viewId: 'self', key: '', value: '' }, output: [], next: '' }],
          },
        },
      },
      idCount: 1,
      ...
      root: {
        ...
        $value: {
          schema: {
            ...
            category: 'action',
            kind: 'setViewVisible',
            slots: [{ input: { viewId: 'self', visible: true }, output: [], next: '' }],
          },
        },
      },
      idCount: 1,
      ...
      root: {
        ...
        $value: {
          schema: {
            ...
            category: 'action',
            kind: 'playAnimation',
            slots: [{ input: { viewId: 'self', animationId: '' }, output: [], next: '' }],
          },
        },
      },
      idCount: 1,
      ...
      root: {
        ...
        $value: {
          schema: {
            ...
            category: 'action',
            kind: 'navigate',
            slots: [{ input: { target: '' }, output: [], next: '' }],
          },
        },
      },
      idCount: 1,
      ...
      root: {
        ...
        $value: {
          schema: {
            ...
            slots: [
              {
                input: { functionId: '', method: 'POST', args: {} },
      ...
      root: {
        ...
        $value: {
          schema: {
            ...
            category: 'function',
            kind: 'function',
            slots: [{ body: { version: '2.0.0', entry: '', nodes: {} }, next: '' }],
          },
        },
      },
      idCount: 1,
      ...
      root: {
        ...
        $value: {
          schema: {
            ...
            category: 'action',
            kind: 'dbQuery',
            slots: [{ input: { collection: '', filter: {} }, output: ['rows', 'count'], next: '' }],
          },
        },
      },
      idCount: 1,
      ...
      root: {
        ...
        $value: {
          schema: {
            ...
            category: 'action',
            kind: 'dbInsert',
            slots: [{ input: { collection: '', document: {} }, output: ['id'], next: '' }],
          },
        },
      },
      idCount: 1,
      ...
      root: {
        ...
        $value: {
          schema: {
            ...
            category: 'action',
            kind: 'dbDelete',
            slots: [{ input: { collection: '', filter: {} }, output: ['deletedCount'], next: '' }],
          },
        },
      },
      idCount: 1,
