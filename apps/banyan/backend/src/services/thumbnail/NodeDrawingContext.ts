...
export class NodeDrawingContext implements IDrawingContext {
  ...
  set globalCompositeOperation(v: string) { this.ctx.globalCompositeOperation = v; }
  ...
  roundRect(x: number, y: number, w: number, h: number, radii?: number | number[]): void {
    if (typeof (this.ctx as unknown as { roundRect?: Function }).roundRect === 'function') {
      (this.ctx as unknown as { roundRect(x: number, y: number, w: number, h: number, radii?: number | number[]): void }).roundRect(x, y, w, h, radii);
    }
  }

  // ── 填充与描边 ──
  fill(fillRule?: "nonzero" | "evenodd"): void { this.ctx.fill(fillRule); }
  ...
  get lineCap(): "butt" | "round" | "square" { return this.ctx.lineCap as "butt" | "round" | "square"; }
  set lineCap(v: "butt" | "round" | "square") { this.ctx.lineCap = v; }
  get lineJoin(): "round" | "bevel" | "miter" { return this.ctx.lineJoin as "round" | "bevel" | "miter"; }
  set lineJoin(v: "round" | "bevel" | "miter") { this.ctx.lineJoin = v; }
  ...
  get imageSmoothingQuality(): "low" | "medium" | "high" { return this.ctx.imageSmoothingQuality as "low" | "medium" | "high"; }
  set imageSmoothingQuality(v: "low" | "medium" | "high") { this.ctx.imageSmoothingQuality = v; }

  // ── 文字 ──
  get font(): string { return this.ctx.font; }
  set font(v: string) { this.ctx.font = v; }
  get textAlign(): "start" | "end" | "left" | "right" | "center" { return this.ctx.textAlign as "start" | "end" | "left" | "right" | "center"; }
  set textAlign(v: "start" | "end" | "left" | "right" | "center") { this.ctx.textAlign = v; }
  ...
  set textBaseline(v: "top" | "hanging" | "middle" | "alphabetic" | "ideographic" | "bottom") { this.ctx.textBaseline = v; }
